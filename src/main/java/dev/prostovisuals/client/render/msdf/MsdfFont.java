package dev.prostovisuals.client.render.msdf;
...
import dev.prostovisuals.client.render.msdf.FontData.AtlasData;
import dev.prostovisuals.client.render.msdf.FontData.GlyphData;
import dev.prostovisuals.client.render.msdf.FontData.MetricsData;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifer = prostovisuals.id("fonts/" + dataFileName + ".json");
			return this;
		}

		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = prostovisuals.id("fonts/" + atlasFileName + ".png");
			return this;
		}

		public MsdfFont build() {
			dev.prostovisuals.client.render.msdf.FontData data = ResourceProvider.fromJsonToInstance(this.dataIdentifer, FontData.class);
