...
public final class SpatialMonitor implements AutoCloseable {
    ...
    private static final int ACTIVE_CAPTURE_WIDTH = 2560;
    ...
    public float height = 2.34f;
    public float curvature = 0.075f;
    ...
    public void uploadPendingFrame() {
        ...
        try {
            ...
            height = Math.max(1.15f, Math.min(2.45f, width / Math.max(0.75f, Math.min(3.0f, sourceAspect))));
