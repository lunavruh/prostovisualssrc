...
public class MainMenu extends Screen {
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        // Wyvern menu composition, but with the requested Among Us mark instead of its logo.
        float logoSize = 54f;
        Render2D.drawTexture(ctx.getMatrices(), width * 0.5f - logoSize * 0.5f,
                height * 0.5f - 132f + (1f - a) * 8f, logoSize, logoSize, 10f, LOGO,
                new Color(255,255,255,(int)(255*a)));
    ...
    private final class GlassButton {
        ...
        void render(DrawContext ctx, int mx, int my, float alpha, float t) {
            ...
            Color ac = themeManager.getRenderedAccentColor();
            if (hv > .01f) {
