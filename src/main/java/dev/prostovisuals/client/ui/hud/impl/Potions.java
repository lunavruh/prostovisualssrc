...
public class Potions extends HudElement implements ThemeManager.ThemeChangeListener {
	...
	public void onRender2D(EventRender2D e) {
        ...
        Color headerAccent = themeManager.getRenderedAccentColor();
		...
		for (int i = 0; i < keys.size(); i++) {
            ...
            Color themeAccent = themeManager.getRenderedAccentColor();
			...
			if (infiniteDuration || !t.isBlank()) {
				...
				Color pillAccent = themeManager.getRenderedAccentColor();
				if (infiniteDuration) {
