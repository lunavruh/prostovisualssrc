...
public class ClickGui extends Screen implements Wrapper {
    ...
    private void renderCategories(DrawContext ctx, int mouseX, int mouseY) {
        ...
        Color logoTintBase = themeManager.getCurrentTheme().getAccentColor();
        ...
        if (languageHovered) {
            Color languageAccent = themeManager.getCurrentTheme().getAccentColor();
    ...
    private Color eventRarityColor(String rarity) {
        ...
        return themeManager.getCurrentTheme().getAccentColor();
    }
