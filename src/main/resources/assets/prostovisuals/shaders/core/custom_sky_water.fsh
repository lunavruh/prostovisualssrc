...
void main(){
 ...
 vec3 base=mix(vec3(.001,.008,.023),vec3(.006,.055,.105),clamp(rd.y*.58+.58,0.,1.));
 vec3 cyan=mix(vec3(.00,.22,.42),vec3(.00,.72,.94),crest);
 vec3 col=base+cyan*crest*(.34+.28*breath)*uAlpha;
 col+=vec3(.00,.18,.30)*broad*.035*breath;
